 ...
 * @final
 */
js.util.Ajax = YAHOO.util.Connect;
/**
 * For initiating an asynchronous request via the XHR object.
 * @method asyncRequest
 * @param {string} method HTTP transaction method
 * @param {string} uri Fully qualified path of resource
 * @param {function} callback:optional User-defined callback function or object
 ...
 * @param {string} isDefault:optional Determines if the specific header is a default header
 ...
 * @param {boolean} isUpload:optional enable file upload.
 * @param {boolean} secureUri:optional enable file upload over SSL in IE only.
