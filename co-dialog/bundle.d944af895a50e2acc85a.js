...
module.exports = {"name":"co-dialog","version":"2.0.0","description":" 这是一个美丽，智能又好用的Javascript弹出框.","main":"webpack.config.js","scripts":{"test":"test","build":"webpack","watch":"webpack watch","start":"webpack-dev-server --open --hot --progress"},"repository":{"type":"git","url":"git+https://github.com/koringz/co-dialog.git"},"keywords":["co-dialog"],"author":"koringz","license":"ISC","bugs":{"url":"https://github.com/koringz/co-dialog/issues"},"homepage":"https://github.com/koringz/co-dialog#readme","devDependencies":{"babel":"^6.23.0","clean-webpack-plugin":"^0.1.19","css-loader":"^1.0.0","file-loader":"^2.0.0","html-webpack-plugin":"^3.2.0","mini-css-extract-plugin":"^0.4.2","postcss-loader":"^3.0.0","sass-loader":"^7.1.0","style-loader":"^0.23.0","webpack":"^4.17.1","webpack-cli":"^3.1.0","webpack-dev-server":"^3.1.7","webpack-encoding-plugin":"^0.2.1"},"dependencies":{"@fdaciuk/ajax":"^2.3.0","@fortawesome/fontawesome-free":"^5.3.1","co-animation":"^1.0.0","jquery":"^3.3.1","server":"^1.0.18"}};
...
/* harmony import */ var _lib_co_dialog_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/co-dialog.js */ "./src/lib/co-dialog.js");
/* harmony import */ var _lib_co_dialog_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_lib_co_dialog_js__WEBPACK_IMPORTED_MODULE_0__);
...
function baseExamples() {
	...
	document.querySelector('.showme.case-beautiful button').onclick = function  (ev) {
		_lib_co_dialog_js__WEBPACK_IMPORTED_MODULE_0___default.a.app(".alert").use(
		 "标题",
		 "这是一个CoDialog组件",
		 "OK"
		).show()
...
function moreExamples () {
	...
	document.querySelector('.show-more-examples .base-class').onclick = function  (ev) {
		_lib_co_dialog_js__WEBPACK_IMPORTED_MODULE_0___default.a.app(".base").use("这是一个基础的弹出框").show()
	}

	document.querySelector('.show-more-examples .with-title-class').onclick = function  (ev) {
		_lib_co_dialog_js__WEBPACK_IMPORTED_MODULE_0___default.a.app(".with-title").use(
		 "默认",
		 "这是一个带标题的弹出框",
		 "OK"
		).show()
	...
	document.querySelector('.show-more-examples .try-drag-class').onclick = function  (ev) {
		_lib_co_dialog_js__WEBPACK_IMPORTED_MODULE_0___default.a.app(".try-drag").use({
		    title: "拖动-isDrag",
		    message: "请尝试拖动窗口",
		    isDrag: true,
		}).show()
	...
	document.querySelector('.show-more-examples .layout-right-bottom-class').onclick = function  (ev) {
		_lib_co_dialog_js__WEBPACK_IMPORTED_MODULE_0___default.a.app(".layout-right-bottom").use({
		    title: "布局-layout",
	...
	document.querySelector('.show-more-examples .timeout-class').onclick = function  (ev) {
		_lib_co_dialog_js__WEBPACK_IMPORTED_MODULE_0___default.a.app(".timeout").use({
		    title: "超时-timeout",
		    message: "超时自动关闭",
		    timeout: "2000",
		}).show()
	...
	document.querySelector('.show-more-examples .cancle-class').onclick = function  (ev) {
		_lib_co_dialog_js__WEBPACK_IMPORTED_MODULE_0___default.a.app(".show-cancle").use({
		    title: "取消-cancle",
		    message: "显示取消按钮和功能",
		    isGesture: true,
		    isDrag: true,
	...
	document.querySelector('.show-more-examples .custom-class').onclick = function  (ev) {
		_lib_co_dialog_js__WEBPACK_IMPORTED_MODULE_0___default.a.app(".custom").use({
		    isGesture: true,
		    isDrag: true,
	...
	document.querySelector('.show-more-examples .customAnimation-class').onclick = function  (ev) {
		_lib_co_dialog_js__WEBPACK_IMPORTED_MODULE_0___default.a.app(".customAnimation").use({
	...
	document.querySelector('.show-more-examples .confirmCallback-class').onclick = function  (ev) {
		_lib_co_dialog_js__WEBPACK_IMPORTED_MODULE_0___default.a.app(".confirmCallback").use({
		    title: "确认回调-confirmCallback",
		    message: "你想清除确认回调函数吗？",
		    showCancleButton: true,
		    confirmCallback: function  () {
		     _lib_co_dialog_js__WEBPACK_IMPORTED_MODULE_0___default.a.app(".confirm-clear-callback").use("你已确定清除").show()
		   },
		}).show()
	}

	document.querySelector('.show-more-examples .theme-purple-class').onclick = function  (ev) {
		_lib_co_dialog_js__WEBPACK_IMPORTED_MODULE_0___default.a.app(".theme-purple").use({
...
let updated_at = sessionStorage.updated_at;
let tag_name = sessionStorage.tag_name;
...
function githubInformation(updated_at$$, tag_name$$) {
	var apiURL = 'https://api.github.com/repos';
	var protoURL = apiURL + '/' + _package_json__WEBPACK_IMPORTED_MODULE_3__["author"] + '/' + _package_json__WEBPACK_IMPORTED_MODULE_3__["name"];
	if(typeof updated_at != 'string') {
		AJAX.get(protoURL).then(function (res,xhr) {
			if(Object.prototype.toString.call(res) == "[object Object]") {
				 updated_at =  res.updated_at;
				 updated_at$$.textContent = updated_at;
				 sessionStorage.updated_at = updated_at;
			}
		})
	}
	if(typeof updated_at != 'string') {
		AJAX.get(protoURL+'/releases/latest').then(function (res,xhr) {
			if(Object.prototype.toString.call(res) == "[object Object]") {
				 ...
				 tag_name$$.textContent = tag_name;
				 sessionStorage.tag_name = tag_name;
			}
		})
	}
}
...
function render(_id, getCacheData) {
	...
	githubInformation(_root.querySelector('.updated_at'), _root.querySelector('.tag_name'));
...
function download () {
	...
	str += '或者下载 CDN: '
	str += '<a href="jsdelivr.com/package/npm/co-dialog">'
