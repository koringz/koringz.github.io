					...
					(function(k) {
						...
						try {
							if ('string' == typeof get_string) {
								get_string += '<p>' + '<span>' + val[p].shift + '</span>' + val[p].map + '<a href=' + val[p].url + ' class=' + 'cc0' + q + ' >' + val[p].word_links + '</a>' + '</p>';
