        ...
        (function() {
            ...
            q[0].assign(o[1][299].prototype, {
                ...
                mergeProperties: function(shapeProperties, thing) {
                    ...
                    if (thing instanceof Object) {
                        combineParams.push({
                            ...
                            startAngles: thing.startAngles || shapeProperties.startAngles,
                            stopAngles: (thing.stopAngles * 4) || (shapeProperties.stopAngles * 4),
                ...
                loop: function(ctx2M, getShapeProperty, j, that) {
                    ...
                    var results = null;
                    try {
                        results = this.iterator.method.call(that, {
