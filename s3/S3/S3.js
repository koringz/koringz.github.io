...
(function (){
  ...
  s3.node.compareProperty = o[1][279];
})();
...
(function (){
  ...
  var com = new s3.node.compareProperty();
  ...
  q[0].assign(o[1][280].prototype, {
    ...
    validateProperty : function (){
      var pointer = this.recivingProperty();
      ...
      var pby = pointer.B2.match_B;
    	 ...
    	 // get new params step
     	var compare = new com.iAO( (this.select[0] && {A:pax,B:pay}) || {A:pax,B:pay}, (this.select[1] && {A:pbx,B:pby}) || {A:pbx,B:pby});
    ...
    setMatchProperty : function (options,nums){
    	 if(nums) this.select[nums] = 1;
    	 this.setMatch = options
    },
  ...
  s3.node.validateDrawProperty = o[1][280];
})();
...
(function (){
  ...
  */
  ...
  q[0].assign(o[1][299].prototype, {
    ...
    draw: function(options) {
      ...
      var validate = new s3.node.validateDrawProperty({x:1,y:2},{x:1,y:2});
  ...
  q[0].assign(o[1][295].prototype, {
    ...
    draw: function(options) {
      ...
      for (var j = 0; j < acceptCollection.length; j++) {
        ...
        _thing.sensitivity = _thing.sensitivity || shapeProperty.sensitivity;
    ...
    start: function(options, ctx2M) {
      ...
      this.getDynamicData(options, beginDistance_x, endDistance_x, this.iterator.x, this.iterator.y, this.iterator.sensitivity, this.iterator.rate, this.iterator.speed, this.iterator.opposite, this.iterator.slope);
  ...
  */
  ...
  /*
    options,count,a
    x,y,_thing.sensitivity, _thing.rate, _thing.speed, i, _thing.opposite
    a = x
    b = y
    c = sensitivity
    d = rate
  ...
  */
  ...
  s3.tweens._circleShape = o[1][299];
  s3.tweens._lineShape = o[1][298];
  s3.tweens._arcShape = o[1][297];
  s3.tweens._rectShape = o[1][296];
  s3.tweens._waveShape = o[1][295];
  s3.tweens._sectorsShape = o[1][294];
  s3.tweens._hatShape = o[1][293];
  s3.tweens._hillShape = o[1][292];
...
Shape.plugin.create('circleShape', s3.tweens._circleShape);
Shape.plugin.create('lineShape', s3.tweens._lineShape);
Shape.plugin.create('arcShape', s3.tweens._arcShape);
Shape.plugin.create('rectShape', s3.tweens._rectShape);
Shape.plugin.create('waveShape', s3.tweens._waveShape);
Shape.plugin.create('sectorsShape', s3.tweens._sectorsShape);
Shape.plugin.create('hatShape', s3.tweens._hatShape);
Shape.plugin.create('hillShape', s3.tweens._hillShape);
