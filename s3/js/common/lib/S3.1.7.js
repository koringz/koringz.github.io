...
q[0].assign(o[1][219].prototype, {
  ...
  validateAbsoluteValue : function (m_val, n_val){
    return Math.abs(m_val - n_val)
  },
  validateSlopeValue : function (_bottom, _power, _symmetric){
    return Math.pow(this.validateSlopeValue(_bottom,_power),_symmetric)
  },
  ...
  */
  validateHalfCycle : function (path, baseNumber){
    var space_path = path || !0;
    var couts = baseNumber || !0;
    return Math.PI / 180 * space_path * couts
  },
...
(function (){
  ...
  */
  ...
  o[1][240].createWave = function(sx, ex, a, b, c, d, e, g, l) {
    ...
    chain_bottom = circle_modelType_chain._location_ynamic_bottom(sx, ex, a, b, c, d, e, g, l, times);
    chain_left = circle_modelType_chain._location_ynamic_left(sx, ex, a, b, c, d, e, g, l, times);
    chain_top = circle_modelType_chain._location_ynamic_top(sx, ex, a, b, c, d, e, g, l, times);
  ...
  q[0].assign(o[1][240].prototype, {
    ...
    _location_ynamic_left: function(sx, ex, a, b, c, d, e, g, l, times) {
    ...
    _location_ynamic_bottom: function(sx, ex, a, b, c, d, e, g, l, times) {
      var x, y, h, k, o, p, r, s, q, m, n, hx4, hy4;
    ...
    _location_ynamic_top: function(sx, ex, a, b, c, d, e, g, l, times) {
      var x, y, h, k, o, p, r, s, q, m, n, hx4, hy4;
