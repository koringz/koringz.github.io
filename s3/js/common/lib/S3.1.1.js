        ...
        Object.assign(o[1][299].prototype, {
            ...
            draw: function(options) {
                ...
                for (var j = 0; j < acceptCollection.length; j++) {
                    ...
                    this.iterator.x = inherit.x = !inherit.x ? shapeProperty.x: inherit.x;
                    this.iterator.y = inherit.y = !inherit.y ? shapeProperty.y: inherit.y;
                    this.iterator.index = inherit.index = !inherit.index ? shapeProperty.index: inherit.index;
                    this.iterator.speed = inherit.speed = !inherit.speed ? shapeProperty.speed: inherit.speed;
                    this.iterator.radius = inherit.radius = !inherit.radius ? shapeProperty.radius: inherit.radius;
                    this.iterator.trails = inherit.trails = !inherit.trails ? shapeProperty.trails: inherit.trails;
                    this.iterator.motion = inherit.motion = !inherit.motion ? shapeProperty.motion: inherit.motion;
                    this.iterator.bMoveMode = inherit.bMoveMode = !inherit.bMoveMode ? shapeProperty.bMoveMode: inherit.bMoveMode; // 只接受二个值(0,1) 如果为1即为true 开启auto 否则stop
                    this.iterator.startAngles = inherit.startAngles = !inherit.startAngles ? shapeProperty.startAngles: inherit.startAngles;
                    this.iterator.stopAngles = inherit.stopAngles = !inherit.stopAngles ? (shapeProperty.stopAngles* 4): (inherit.stopAngles* 4); // 默认2 pi
        ...
        Object.assign(o[1][298].prototype, {
            ...
            draw: function(options) {
                ...
                for (var j = 0; j < acceptCollection.length; j++) {
                    ...
                    this.iterator.x = inherit.x = !inherit.x ? shapeProperty.x: inherit.x;
                    this.iterator.y = inherit.y = !inherit.y ? shapeProperty.y: inherit.y;
                    this.iterator.x1 = inherit.x1 = !inherit.x1 ? shapeProperty.x1: inherit.x1;
                    this.iterator.y1 = inherit.y1 = !inherit.y1 ? shapeProperty.y1: inherit.y1;
                    this.iterator.index = inherit.index = !inherit.index ? shapeProperty.index: inherit.index;
        ...
        Object.assign(o[1][297].prototype, {
            ...
            draw: function(options) {
                ...
                for (var j = 0; j < acceptCollection.length; j++) {
                    ...
                    this.iterator.radius = inherit.radius = !inherit.radius ? shapeProperty.radius: inherit.radius;
                    this.iterator.startAngles = inherit.startAngles = !inherit.startAngles ? shapeProperty.startAngles: inherit.startAngles;
                    this.iterator.stopAngles = inherit.stopAngles = !inherit.stopAngles ? shapeProperty.stopAngles: inherit.stopAngles;
        ...
        Object.assign(o[1][296].prototype, {
            ...
            draw: function(options) {
                ...
                for (var j = 0; j < acceptCollection.length; j++) {
                    ...
                    this.iterator.y1 = inherit.y1 = !inherit.y1 ? shapeProperty.y1: inherit.y1;
                    this.iterator.index = inherit.index = !inherit.index ? shapeProperty.index: inherit.index;
                    this.iterator.thick = inherit.thick = !inherit.thick ? shapeProperty.tick: inherit.thick;
                    this.iterator.borderColor = inherit.borderColor = !inherit.borderColor ? shapeProperty.borderColor: inherit.borderColor;
        ...
        Object.assign(o[1][295].prototype, {
            ...
            draw: function(options) {
                ...
                for (var j = 0; j < acceptCollection.length; j++) {
                    ...
                    this.iterator.x = inherit.x = !inherit.x ? shapeProperty.x: inherit.x;
                    this.iterator.y = inherit.y = !inherit.y ? shapeProperty.y: inherit.y;
                    this.iterator.rate = inherit.rate = !inherit.rate ? shapeProperty.rate: inherit.rate;
                    this.iterator.index = inherit.index = !inherit.index ? shapeProperty.index: inherit.index;
                    this.iterator.speed = inherit.speed = !inherit.speed ? shapeProperty.speed - this.s_SPEED: inherit.speed - this.s_SPEED;
                    this.iterator.slope = inherit.slope = !inherit.slope ? shapeProperty.slope: inherit.slope;
                    this.iterator.opposite = inherit.opposite = !inherit.opposite ? shapeProperty.opposite: inherit.opposite;
                    this.iterator.sensitivity = inherit.sensitivity = !inherit.sensitivity ? shapeProperty.sensitivity: inherit.sensitivity;
                    this.iterator.readyPosition = inherit.readyPosition = !inherit.readyPosition ? shapeProperty.readyPosition: inherit.readyPosition;
                    this.iterator.beginPosition = inherit.beginPosition = !inherit.beginPosition ? shapeProperty.beginPosition: inherit.beginPosition;
                    this.iterator.endPosition = inherit.endPosition = !inherit.endPosition ? shapeProperty.endPosition: inherit.endPosition;
            ...
            */
            ...
            // excuting the arc events 
            _lineTo: function(options) {
                this.data[0].lineTo(options.x,options.y);// 从0 到总width宽度的实际长度
            },
            // setting color properties
            _strokeStyle: function(options) {
                this.data[0].strokeStyle = this.iterator.index;
        ...
        Object.assign(o[1][292].prototype, {
            ...
            draw: function(options) {
                ...
                for (var j = 0; j < acceptCollection.length; j++) {
                    ...
                    this.iterator.startAngles = inherit.startAngles = !inherit.startAngles ? shapeProperty.startAngles: inherit.startAngles;
                    this.iterator.stopAngles = inherit.stopAngles = !inherit.stopAngles ? (shapeProperty.stopAngles  * 4): (inherit.stopAngles  * 4);// 默认2 pi
                    this.iterator.direction = inherit.direction = !inherit.direction ? shapeProperty.direction: inherit.direction;
                    this.iterator.smooth = inherit.smooth = !inherit.smooth ? shapeProperty.smooth: inherit.smooth;
        ...
        Object.assign(o[1][232].prototype, {
            ...
            */
            takeInteger: function (min,max){
                ...
                return  ((smoothness >= m)?(pointNums = smoothness % m)?
                        ( pointNums >=(m - n) )?(o = smoothness):
                        ( o = m ):(o = smoothness):(o = smoothness))&&
                        (pointNums = o) & pointNums
            },
            /*
              - 总共的点为pointNums 
              - 每一个点的度数为angleNums
