(function(foctory) { !
    function(factory) {
        ...
        */
        ...
        o[1][239] = q[1][239];
        o[1][239].createCircle = function(aa, bb, modelType) {
            ...
            chain_top =  circle_modelType_chain._location_top(aa, bb, times);
            // chain_auto =  circle_modelType_chain._location(aa, bb, times);
            // chain_left =  circle_modelType_chain._location(aa, bb, times);
            // chain_right =  circle_modelType_chain._location(aa, bb, times);
            // chain_bottom =  circle_modelType_chain._location(aa, bb, times);
            // chain_random =  circle_modelType_chain._location(aa, bb, times);

            return {
                'round' : chain_round.results,
                'top' : chain_top.results,
                // 'auto' : chain_auto.results,
                // 'left' : chain_left.results,
                // 'right' : chain_right.results,
                // 'bottom' : chain_bottom.results,
                // 'random' : chain_random.results,
            }
        }
