...
/*
- circle line rect Polygon chain
- circle shape
  ...
  q[0].assign(o[1][295].prototype, {
    ...
    */
    getDynamicData: function(_createWave, _a, _b, _c, _d, _e, _f, _g, _l, _m) {
      ...
      // 默认获得一个向右的运动轨迹
      // especially of base property
      this.iterator.dynamic.group = waveModule[this.iterator.direction];
    },
    Excute2DEngine: function() {
      // accept ctx 2d property.
      var d2 = arguments[0],
...
q[0].assign(o[1][219].prototype, {
  ...
  */
  validatePower : function (_bottom, _power, _symmetric){
    return Math.pow(Math.pow(_bottom,_power),_symmetric)
  },
  /*
...
(function (){
  ...
  */
  ...
  o[1][240].createWave = function(sx, ex, a, b, c, d, e, g, l) {
    ...
    var lineChain = new o[1][240]()
    var commonArg = new lineChain.commonArguments(sx, ex, a, b, c, d, e, g, l, times)

    return {
      'bottom': commonArg.fallback(lineChain, lineChain.dynamic_bottom)[0].results,
      'left': commonArg.fallback(lineChain, lineChain.dynamic_left)[0].results,
      'right': commonArg.fallback(lineChain, lineChain.dynamic_right)[0].results,
      'top': commonArg.fallback(lineChain, lineChain.dynamic_top)[0].results,
    }
  }
  q[0].assign(o[1][240].prototype, {
    ...
    // call the method of parameters
    commonArguments: function  () {
      var args = arguments
      return {
        fallback : function (that, shift){
          return shift.apply(that, args)
        }
      }
    },
    validateQuery : function ( min, max, a, b, c, d, e, g, l , y, z){
      var so_pos = {}
      var so_pow = null
      var so_rat = null
      var so_fra = null
      ...
      for (var i = min; i < max; i++) {
        ...
        so_pos = this.station_one( i, a, b )
        so_pow = this.station_two( l, so_pos.hy, so_pos.hx )
        so_rat = this.station_three( so_pow, b, d )
        so_fra = this.station_four( i, c )
        so_cos = this.station_five( so_fra, e )
        so_ret = this.station_six( b, so_rat, so_cos, g , y, -i)

        z ? empty.push([max/2 + so_rat * so_cos,so_ret]) : empty.push([i,so_ret])
      }

      return [{results: empty}]
    },
    // calc position
    station_one: function  ( index, a, b, so_p ) {
        math.setAbsoluteValue( index, a );
        math.setAbsoluteValue( index, b );
        // 1/4 of the width and height
        var hx4 = math.getAbsoluteValue();
        var hy4 = math.getAbsoluteValue();
        return so_p = {
          hx: hx4,
          hy: hy4
        }
    ...
    // calc pow
    station_two: function  ( l, hy4, hx4, so_pow ) {
      return  so_pow = math.validatePower(l, hy4, hx4);
    },
    // calc rate
    station_three: function  ( so, c, d, so_rat ) {
      return so_rat = so * c / d
    },
    // every frame angles
    station_four: function  ( index, c, so_fra ) {
      return so_fra = math.validateHalfCycleEachFrames( index, c )
    },
    // every frame cos geo
    station_five : function  ( so, e, so_cos ) {
      return so_cos = math.geometryCoordinatCosRadius( so + e )
    },
    station_six : function  ( b, so_rat, so_cos, g, y, index) {
      return y ? (index + b + so_rat * so_cos * g) : (b + so_rat * so_cos * g);
    },
    dynamic_left: function( sx, ex, a, b, c, d, e, g, l, times ) {
      return this.validateQuery(sx, ex, a, b, c, d, e, g, l)
    },
    dynamic_right: function(sx, ex, a, b, c, d, e, g, l, times) {
      return this.validateQuery(sx, ex, a, b, -c, d, e, g, l)
    },
    dynamic_bottom: function(sx, ex, a, b, c, d, e, g, l, times) {
      return this.validateQuery(sx, ex, a, b, c, d, e, g, l, 1, 1)
    },
    dynamic_top: function(sx, ex, a, b, c, d, e, g, l, times) {
      return this.validateQuery(sx, ex, a, b, -c, d, e, g, l, 1, 1)
    }
  });
